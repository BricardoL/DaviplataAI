...
const AgregarABene = () => {
  ...
  return (
    <View style={[styles.agregarABene, styles.labelFlexBox]}>
      <View style={[styles.agregarABeneChild, styles.agregarShadowBox]} />
      ...
      <View style={[styles.agregarABeneItem, styles.agregarLayout]} />
      <View style={[styles.homeIndicator, styles.homePosition]}>
        <View style={[styles.homeIndicator1, styles.homePosition]} />
      </View>
      <Text style={styles.todosLosContactos}>Todos los contactos</Text>
      <View style={[styles.agregarABeneInner, styles.agregarLayout]} />
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("AgregarAdri")}
      >
